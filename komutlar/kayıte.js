...
exports.run = (client, message, args) => {
  const kayıtlı3 = message.guild.roles.find(r => r.id === "767786561223786496"); //buraya kayıtlı rolünüzün id'sini koyun.
  const kayıtlı2 = message.guild.roles.find(r => r.id === "769618791583449128"); //buraya kayıtlı rolünüzün id'sini koyun.
  const kayıtlı = message.guild.roles.find(r => r.id === "769618748150775838"); //buraya kayıtlı rolünüzün id'sini koyun.
